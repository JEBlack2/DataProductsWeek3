...
## Load the BankRate Data

```{r getData, echo=FALSE}
brFileName <- "2015.03.BankRateSurvey.xlsx"
...
```
* We set parameters for the Choropleth map, and assembled information to be displayed whenever the mouse hovers over a state; may need to zoom the map to see it all.
